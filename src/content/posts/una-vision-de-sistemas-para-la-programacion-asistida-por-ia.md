...
![Diagrama de sub-sistemas y flujos de un Asistente de Programación](/2025/11/03/attachments/CleanShot-2025-11-04-at-12.56.59@2x.png)
...
- **Modelo**: En general un LLM *optimizado para poder utilizar este sistema a su alrededor*. En este momento, y dependiendo de preferencias, estamos hablando de un Sonnet 4.5 (Anthropic), GPT-4o (OpenAI), Gemini 2.5 Pro, Kimi K2 (Moonshot), GLM-4.5 (Z.ai), etc... o una combinación de diversos modelos en diferentes momentos o incluso un sub-sistema de agentes.
