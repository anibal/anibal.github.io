---
title: "Using a Github Page with your own Domain to publish you Obsidian vault through Quartz for free"
description: "This is a detailed step-by-step tutorial that will allow you to set up Quartz to publish a folder of your vault as a website for free in Github Pages, is mostly a reminder for myself, I hope that it may be useful for you."
date: 2025-10-18
lang: en
tags:
  - github-pages
...
![Obsidian file explorer showing a Public folder with an index file at the root of the vault](/2025/10/18/attachments/CleanShot-2025-10-19-at-17.35.29@2x.png)

And copy the path, *full path*, to the `Public` folder as it will be required later when setting up Quartz:

![Obsidian context menu with the Copy path option for the Public folder](/2025/10/18/attachments/CleanShot-2025-10-19-at-17.36.34@2x.png)
...
![GitHub new repository form creating a public anibal.github.io repository without README, .gitignore or license](/2025/10/18/attachments/CleanShot-2025-10-19-at-16.51.09@2x.png)
...
![Browser showing a GitHub Pages 404 error for the still-empty repository](/2025/10/18/attachments/CleanShot-2025-10-19-at-17.04.22@2x.png)
...
![GitHub repository Code button showing the SSH clone URL](/2025/10/18/attachments/CleanShot-2025-10-19-at-16.56.21@2x.png)
...
![Obsidian Files and links settings with link format set to shortest path](/2025/10/18/attachments/CleanShot-2025-10-19-at-17.48.43@2x.png)
...
![Quartz site rendered locally at localhost:8080 showing the index page](/2025/10/18/attachments/CleanShot-2025-10-19-at-17.56.08@2x-1.png)
...
![GitHub repository Pages settings with GitHub Actions selected as the deployment source](/2025/10/18/attachments/CleanShot-2025-10-19-at-18.19.13@2x.png)

After this change, you should see the something like:

![GitHub Pages settings after selecting GitHub Actions as the source](/2025/10/18/attachments/CleanShot-2025-10-19-at-18.21.53@2x.png)
...
![Published Quartz site served at the username.github.io address](/2025/10/18/attachments/CleanShot-2025-10-19-at-17.56.08@2x-1.png)
...
![GitHub Pages domain verification screen showing the TXT record name and value to copy](/2025/10/18/attachments/CleanShot-2025-10-19-at-18.41.35@2x.png)
...
![DNS management panel with the TXT verification record added](/2025/10/18/attachments/CleanShot-2025-10-19-at-18.49.52@2x.png)
...
![DNS management panel with a CNAME record pointing the subdomain to username.github.io](/2025/10/18/attachments/CleanShot-2025-10-19-at-19.03.44@2x.png)
...
![GitHub repository Pages settings with the custom subdomain added and saved](/2025/10/18/attachments/CleanShot-2025-10-19-at-19.05.24@2x.png)
...
![Published site loading over plain HTTP before a certificate is provisioned](/2025/10/18/attachments/CleanShot-2025-10-19-at-19.11.30@2x.png)
...
![GitHub Pages settings with the Enforce HTTPS option available](/2025/10/18/attachments/CleanShot-2025-10-19-at-19.24.29@2x.png)
# Write and Sync
